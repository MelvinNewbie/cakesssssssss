...
<body>
        ...
        <div class="container mt-3">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto" style="font-weight: bolder;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="z_item.php">Add Product</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-2 blur bg-transparent border border-white mb-2" style="color: white; text-align: center;">
            ...
            <div class="col-10 p-3 mb-2 bg-transparent border border-white blur" style="color: white;">
               <h3>Update Record</h3>
                <?php
